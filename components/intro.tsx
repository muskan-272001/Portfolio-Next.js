    ...
    >
      ...
      >
        ...
        <a
          ...
          focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border borderBlack 
          dark:bg-white/10"
          href="/CV.pdf"
          download
        >
        ...
        <a
          ...
          cursor-pointer border borderBlack dark:bg-white/10 dark:text-white/60"
