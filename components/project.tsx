...
export default function Project({
  ...
  return (
    ...
    >
      ...
      border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 
      transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20"
      >
        <div
        ...
        >
          ...
          <div className="p-2 flex gap-7 justify-start">
            <a
              className="flex justify-between gap-5 text-[2.35rem] 
          rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 
          transition cursor-pointer dark:text-white/90 max-w-20"
              href={githubUrl}
            >
              <FaGithubSquare />
            </a>
